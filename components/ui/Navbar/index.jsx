...
const Navbar = () => {
    ...
    const navigation = [
        { title: "Home", path: "#features" },
        { title: "Our Service", path: "#toolkit" },
        { title: "Sample Product", path: "#toolkit" },
        { title: "Contact Us", path: "#testimonials" },
    ]
                        ...
                        <ul className="text-gray-700 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0 md:text-gray-600 md:font-medium">
                            {
                                navigation.map((item, idx) => {
                                    return (
                                        <li key={idx} className="text-lg duration-150 hover:text-gray-900">
                                            <Link
                                                href={item.path}
                                                className="block"
                                            >
